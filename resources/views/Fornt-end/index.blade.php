    ...
    <body id="page-top">
        ...
        <header class="masthead" style=" background-image: url(<?php echo $main->bc_img ?>)">
            <div class="container">
                ...
                <a class="btn btn-primary btn-xl text-uppercase" href="{{ url($main->resume
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModa<?php echo $portfolio->id ?>">
